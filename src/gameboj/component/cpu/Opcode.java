...
public enum Opcode {
    ...
    Opcode(Kind kind, Family family, int encoding, int totalBytes, int cycles, int additionalCycles) {
        this.kind = kind;
        this.family = family;
    ...
    Opcode(Kind kind, Family family, int encoding, int totalBytes, int cycles) {
